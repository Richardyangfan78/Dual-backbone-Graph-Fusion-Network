#!/usr/bin/env python3
"""
predict_inorg_mace_m3gnet.py — MACE+M3GNet DualBackbone inference (inorg models)
...
CKPT_DIR  = os.path.join(PROJECT, "checkpoints/mace_m3gnet_inorg")
M3G_DIR   = os.path.join(PROJECT, "checkpoints/m3gnet_mt_inorg")
...
def main():
    ...
    parser.add_argument("output_csv", nargs="?",
                        default="predictions_inorg_mace_m3gnet.csv")
    ...
    print(f"Loading {N_FOLDS} fold checkpoints (mace_m3gnet_inorg) ...")
    models, norms = [], []
    ...
    print(f"\n── Screening Summary (mace_m3gnet_inorg) ──")
