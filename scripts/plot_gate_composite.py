...
Reads:  results/gate_analysis/gate_analysis.csv
Writes: results/gate_analysis/fig2_gate_composite.png
"""
import os, sys
import numpy as np
import pandas as pd
...
DATA = os.path.join(BASE, "results/gate_analysis/gate_analysis.csv")
OUT  = os.path.join(BASE, "results/gate_analysis/fig2_gate_composite.png")
...
# ── Load data ─────────────────────────────────────────────────────────────────
df = pd.read_csv(DATA)
# Encoding: gt_true=0 → Direct, gt_true=1 → Indirect/Metal
...
# ── Suptitle ──────────────────────────────────────────────────────────────────
fig.suptitle(
    "Figure 2  |  Gate weight analysis of the DBGFN model across 2,529 chalcohalide compounds",
